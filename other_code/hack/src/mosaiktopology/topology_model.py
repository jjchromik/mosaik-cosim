...
# rtu_info is a dict of the branch name and "True" or "False" indicator,
# e.g. {"branch_1: 1. branch_16: 0"}
...
def connected_buses(json_data, init_bus='tr_pri'):
    ...
    # create a new graph each time because we add edges if they exist.
    g.clear()
